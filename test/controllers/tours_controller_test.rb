...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference("Tour.count") do
      post tours_url, params: { tour: { description: @tour.description, price: @tour.price, title: @tour.title } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { description: @tour.description, price: @tour.price, title: @tour.title } }
